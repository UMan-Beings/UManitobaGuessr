...
* [Gradle Build Scans – insights for your project's build](https://scans.gradle.com#This project contains a Docker Compose file named `compose.yaml`.
In this fThis project contains Docker Compose files named `docker-compose.dev.yaml` `docker-compose.prod.yaml`.
In these files, the following services have been defined:

* postgres: [`postgres:18`](https://hub.docker.com/_/postgres)
mages and set them to the same as you're running in production.
