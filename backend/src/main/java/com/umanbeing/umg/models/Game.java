 ...
 * class is mapped to the "GAME" table in the database.
 *
 * <p>It has the following attributes:
 * <li>{@link Long} gameId
 * <li>{@link User} user
 * <li>{@link Integer} maxTimerSeconds
 * <li>{@link Integer} totalRounds
 * <li>boolean isCompleted
 * <li>{@link GameState} gameState
 * <li>{@link Integer} currentRoundNumber
