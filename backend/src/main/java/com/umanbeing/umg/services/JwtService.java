...
public class JwtService {
     ...
     * <p>
     * This method ensures the token is valid and not expired, then extracts the username claim.
    ...
    /**
     * Refreshes the JWT token by generating a new one for the same user.
     * It calls {@link #validateTokenAndRetrieveSubject(String)} to validate the token
     * and extract the username from the token.
